...
public class NameValidator implements Validator {
    ...
    public NameValidator(TextField textField) {
    ...
    public Notification getInvalidArgumentNotification() {
        return NotificationFactory.defaultInvalidArguementNotification("Invalid name",
                "The name \"" + textField.getText() + "\" is not correct. " +
                        "Please enter a correct name value");
    }
}
