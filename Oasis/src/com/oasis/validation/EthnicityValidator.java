...
public class EthnicityValidator implements Validator {
    private final TextField textField;
    private StringProperty value = new SimpleStringProperty();
    private ChangeListener<String> valueChangeListener;
    private boolean valid = false;

    public EthnicityValidator(TextField textField) {
    ...
    public Notification getInvalidArgumentNotification() {
        return NotificationFactory.defaultInvalidArguementNotification("Invalid ethnicity",
                "The ethnicity \"" + textField.getText() + "\" is not correct. " +
                        "Please enter a correct ethnicity");
    }
}
