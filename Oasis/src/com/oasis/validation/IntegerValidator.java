...
public class IntegerValidator implements Validator {
    ...
    public IntegerValidator(TextField textField) {
    ...
    public Notification getInvalidArgumentNotification() {
        return NotificationFactory.defaultInvalidArguementNotification("Invalid number",
                "The number \"" + textField.getText() + "\" is not correct. " +
