...
public class EmployeeManagementController implements Controller {
    ...
    public void refreshView() {
        ...
        for (Employee employee : EmployeeServices.getEmployeeArrayList(UIName.EMPLOYEE_MANAGEMENT)) {
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        EmployeeServices.updateEmployee(UIName.EMPLOYEE_MANAGEMENT, new ArrayList<>(editedEmployeeHashMap.values()));
        editedEmployeeHashMap.clear();

        EmployeeServices.deleteEmployee(UIName.EMPLOYEE_MANAGEMENT, new ArrayList<>(deletedEmployeeHashMap.values()));
        deletedEmployeeHashMap.clear();
