...
public class PatientManagementController implements Controller {
        ...
        patientTableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            if (patientTableView.getSelectionModel().getSelectedItem() != null) {
                if (oldValue != null) {
                    ...
                    PatientServices.removeEmptyAttributes(UIName.PATIENT_MANAGEMENT, oldValue);
    ...
    public void refreshView() {
        ...
        for (Patient patient : PatientServices.getPatientArrayList(UIName.PATIENT_MANAGEMENT)) {
        ...
        ObservableList<Ethnicity> ethnicityObservableList = FXCollections
                .observableList(EthnicityServices.getEthnicityArrayList(UIName.PATIENT_MANAGEMENT));
        ethnicityComboBox.setItems(ethnicityObservableList);
        ObservableList<BloodGroup> bloodGroupObservableList = FXCollections
                .observableList(BloodGroupServices.getBloodGroupArrayList(UIName.PATIENT_MANAGEMENT));
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        PatientServices.updatePatient(UIName.PATIENT_MANAGEMENT, new ArrayList<>(editedPatientHashMap.values()));
        editedPatientHashMap.clear();

        PatientServices.deletePatient(UIName.PATIENT_MANAGEMENT, new ArrayList<>(deletedPatientHashMap.values()));
        deletedPatientHashMap.clear();
