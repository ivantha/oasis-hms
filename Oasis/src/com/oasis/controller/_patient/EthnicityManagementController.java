...
public class EthnicityManagementController implements Controller {
    ...
    public void refreshView() {
        ...
        for (Ethnicity ethnicity : EthnicityServices.getEthnicityArrayList(UIName.ETHNICITY_MANAGEMENT)) {
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        EthnicityServices.updateEthnicity(UIName.ETHNICITY_MANAGEMENT, new ArrayList<>(editedEthnicityHashMap.values()));
        editedEthnicityHashMap.clear();

        EthnicityServices.deleteEthnicity(UIName.ETHNICITY_MANAGEMENT, new ArrayList<>(deletedEthnicityHashMap.values()));
        deletedEthnicityHashMap.clear();
