...
public class TreatmentManagementController implements Controller {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        patientAutoCompleteFXC = new AutoCompleteFXC<>(searchParam ->
                PatientServices.getPatientLike(UIName.TREATMENT_MANAGEMENT, searchParam), UIName.PATIENT_DETAILS_POPOVER);
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        TreatmentServices.updateTreatment(UIName.TREATMENT_MANAGEMENT, new ArrayList<>(editedTreatmentHashMap.values()));
        editedTreatmentHashMap.clear();

        TreatmentServices.deleteTreatment(UIName.TREATMENT_MANAGEMENT, new ArrayList<>(deletedTreatmentHashMap.values()));
    ...
    private void updateAdmissionTable(Patient patient) {
        ...
        for (Admission admission : AdmissionServices.getAdmissionArrayListByPatient(UIName.TREATMENT_MANAGEMENT, patient)) {
    ...
    private void updateTreatmentTable(Admission admission) {
        ...
        for (Treatment treatment : TreatmentServices.getTreatmentArrayListByAdmission(UIName.TREATMENT_MANAGEMENT, admission)) {
