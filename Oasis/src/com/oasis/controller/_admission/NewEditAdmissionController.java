...
public class NewEditAdmissionController implements Controller {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        patientAutoCompleteFXC = new AutoCompleteFXC<>(searchParam ->
                PatientServices.getPatientLike(UIName.NEW_EDIT_ADMISSION, searchParam), UIName.PATIENT_DETAILS_POPOVER);
        physicianAutoCompleteFXC = new AutoCompleteFXC<>(searchParam ->
                PhysicianServices.getPhysicianLike(UIName.NEW_EDIT_ADMISSION, searchParam), UIName.PHYSICIAN_DETAILS_POPOVER);
    ...
    public void okButtonOnAction(ActionEvent actionEvent) {
        ...
        if (!isEditingMode) {
            AdmissionServices.newAdmission(UIName.NEW_EDIT_ADMISSION, admissionArrayList);
        } else {
            AdmissionServices.updateAdmission(UIName.NEW_EDIT_ADMISSION, admissionArrayList);
        }
