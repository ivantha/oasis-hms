...
//        popOver.getRoot().getStylesheets().add(cssURL.toExternalForm());
    ...
    private void addValidators() {
        ...
        validationFactory.addDatePickerValidator(startDateDatePicker);
//        validationFactory.addDatePickerValidator(endDateDatePicker);
        validationFactory.addComboBoxValidator(employeeRoleComboBox);
        validationFactory.addTimePickerValidator(shiftStartTimeTimePicker);
        validationFactory.addTimePickerValidator(shiftEndTimeTimePicker);
