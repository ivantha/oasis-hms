package com.oasis.controller._payment;
...
public class PaymentManagementController implements Controller {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        patientAutoCompleteFXC = new AutoCompleteFXC<>(searchParam ->
                PatientServices.getPatientLike(UIName.PAYMENT_MANAGEMENT, searchParam), UIName.PATIENT_DETAILS_POPOVER);
    ...
    public void refreshView() {
        ...
        currentPatientChangeListener = (observable, oldValue, newValue) -> {
            ...
            for (Admission admission : AdmissionServices.getAdmissionArrayListByPatient(UIName.PAYMENT_MANAGEMENT, newValue)) {
    ...
    public void newButtonOnAction(ActionEvent actionEvent) {
        ...
        if (null != selectedAdmission) {
            ...
            PaymentServices.newPayment(UIName.PAYMENT_MANAGEMENT, newPaymentArrayList);
    ...
    public void deleteButtonOnAction(ActionEvent actionEvent) {
        ...
        if (selectedPayment != null) {
            ...
            PaymentServices.deletePayment(UIName.PAYMENT_MANAGEMENT, deletePaymentArrayList);
        }
    }

    private void updateChargeTable(Admission admission) {
        ArrayList<Charge> chargeArrayList = new ArrayList<>();
        for (Charge charge : ChargeServices.getChargeArrayListByAdmission(UIName.PAYMENT_MANAGEMENT, admission)) {
    ...
    private void updatePaymentTable(Admission admission) {
        ...
        for (Payment payment : PaymentServices.getPaymentArrayListByAdmission(UIName.PAYMENT_MANAGEMENT, admission)) {
