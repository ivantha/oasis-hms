...
public class PhysicianManagementController implements Controller {
    ...
    private ObservableList<Physician> physicianObservableList;
    ...
    public void refreshView() {
        ...
        physicianObservableList = FXCollections.observableList(physicianArrayList);
    ...
    public void deleteButtonOnAction(ActionEvent actionEvent) {
        ...
        if (selectedPhysician != null) {
            physicianObservableList.remove(selectedPhysician);
