...
public class TestManagementController implements Controller {
    ...
    public void refreshView() {
        ...
        for (Test test : TestServices.getTestArrayList()) {
            testArrayList.add(test.clone());
            tempTestHashMap.put(test.getId(), test.clone());
        }

        searchTextField.setText(null);
        testObservableList = FXCollections.observableList(testArrayList);
    ...
    public void deleteButtonOnAction(ActionEvent actionEvent) {
        ...
        if (selectedTest != null) {
            testObservableList.remove(selectedTest);
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        TestServices.updateTest(new ArrayList<>(editedTestHashMap.values()));
        editedTestHashMap.clear();

        TestServices.deleteTest(new ArrayList<>(deletedTestHashMap.values()));
        deletedTestHashMap.clear();
