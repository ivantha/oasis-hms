...
public class SpecialityManagementController implements Controller {
    ...
    private ObservableList<Speciality> specialityObservableList;
    ...
    public void refreshView() {
        ...
        for (Speciality speciality : SpecialityServices.getSpecialityArrayList()) {
            specialityArrayList.add(speciality.clone());
            tempSpecialityHashMap.put(speciality.getId(), speciality.clone());
        }

        searchTextField.setText(null);
        specialityObservableList = FXCollections.observableList(specialityArrayList);
    ...
    public void deleteButtonOnAction(ActionEvent actionEvent) {
        ...
        if (selectedSpeciality != null) {
            specialityObservableList.remove(selectedSpeciality);
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        SpecialityServices.updateSpeciality(new ArrayList<>(editedSpecialityHashMap.values()));
        editedSpecialityHashMap.clear();

        SpecialityServices.deleteSpeciality(new ArrayList<>(deletedSpecialityHashMap.values()));
        deletedSpecialityHashMap.clear();
