...
import com.oasis.controller.admission.NewEditAdmissionController;
...
public class AdmissionManagementController implements Controller {
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        AdmissionServices.updateAdmission(new ArrayList<>(editedAdmissionHashMap.values()));
        editedAdmissionHashMap.clear();

        AdmissionServices.deleteAdmission(new ArrayList<>(deletedAdmissionHashMap.values()));
        deletedAdmissionHashMap.clear();
    }
