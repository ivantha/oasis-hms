package com.oasis.controller._administration;
...
public class WardManagementController implements Controller {
    ...
    public void refreshView() {
        ...
        for (Ward ward : WardServices.getWardArrayList(UIName.WARD_MANAGEMENT)) {
        ...
        ObservableList<Gender> genderObservableList = FXCollections
                .observableList(GenderServices.getGenderArrayList(UIName.WARD_MANAGEMENT));
    ...
    public void saveButtonOnAction(ActionEvent actionEvent) {
        ...
        WardServices.updateWard(UIName.WARD_MANAGEMENT, new ArrayList<>(editedWardHashMap.values()));
        editedWardHashMap.clear();

        WardServices.deleteWard(UIName.WARD_MANAGEMENT, new ArrayList<>(deletedWardHashMap.values()));
        deletedWardHashMap.clear();
